# training_validation_Davis_KIBA_SELFIES.py
#
...
from models.MLSDTA_token import MLSDTA_token
from models.MLSDTA import MLSDTA

from models.MLSDTA_Target_GAT import MLSDTA_Target_GAT
from models.DGraphDTA import Dgraphdta

from models.Ablation.ablation_g import ablation_g
from models.Ablation.ablation_s import ablation_s
from models.Ablation.ablation_gs import ablation_gs
from models.Ablation.ablation_NoCA import experiment_NoCA
from models.Ablation.ablation_NoDropNode import experiment_NoDropNode
from models.Ablation.ablation_NoPool import experiment_NoPool


from models.hyperparameters.dropnode_rate05 import dropnode_rate_05
# 睡眠四小时
# time.sleep(14400)

datasets = ['davis', 'kiba']
# datasets = ['davis']  # 先只用davis 看效果
# datasets = ['kiba']
# modeling = [ASAPool_GCNX,ASAPool_newCA,ASAPool_model,ASAPool_CA_model][3]
# modeling = [ASAPool_3DN_model,ASAPool_CA_model,ASAPool_model,Experiment_2SE_PN_SA,Experiment_2SE_PN_CA, Experiment_PN, Experiment_1 ][1]

''' 消融实验 '''
modeling = [MLSDTA][0]
# modeling = [experiment_NoCA,experiment_NoDropNode,experiment_NoPool][2]
'''超参数实验'''
# modeling = [pool_rate_06,pool_rate_07,pool_rate_08,pool_rate_09][3]
# modeling = [dropnode_rate_05][0]

"MLSDTA实验"
# modeling = [Dgraphdta][0]
